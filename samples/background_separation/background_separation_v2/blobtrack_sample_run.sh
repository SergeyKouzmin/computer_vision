...
#LD_LIBRARY_PATH="./../../../external_libs/lib" ./blobtrack_sample ./iq720p.mp4 fg=FG_1 bd=BD_Simple bt=MSFG

LD_LIBRARY_PATH="/usr/local/lib" ./blobtrack_sample /home/user/iq720p.mp4 fg=FG_1 bd=BD_Simple bt=MSFG
